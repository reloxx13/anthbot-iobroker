...
class AnthbotShadowApiClient {
    constructor({ http, serialNumber, regionName, iotEndpoint, awsConfig = {} }) {
        this.http = http;
    ...
    accessKeyId() {
        if (this.iotEndpoint === CN_NORTHWEST_IOT_ENDPOINT) {
            return this.awsConfig.awsAccessKeyCnNorthwest || "";
        }
        if (this.signingRegion.startsWith("cn")) {
            return this.awsConfig.awsAccessKeyCn || "";
        }
        return this.awsConfig.awsAccessKeyDefault || "";
    }

    secretAccessKey() {
        if (this.iotEndpoint === CN_NORTHWEST_IOT_ENDPOINT) {
            return this.awsConfig.awsSecretKeyCnNorthwest || "";
        }
        if (this.signingRegion.startsWith("cn")) {
            return this.awsConfig.awsSecretKeyCn || "";
        }
        return this.awsConfig.awsSecretKeyDefault || "";
    }
    ...
    async publishServiceCommand({ cmd, data }) {
...
function generalMowerStatus(data) {
    ...
    if (["globalmowing", "zonemowing", "pointmowing", "bordermowing", "regionmowing", "nestmowing"].includes(raw)) {
        return "mowing";
    }
